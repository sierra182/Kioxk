(function () {  
    ...
    if (!isChrome) {
        alert("Cette Application est optimisée pour les navigateurs basés sur Chromium: ( Chrome, Edge, Opera...). Si vous rencontrez des problemes d'affichage ou d'utilisation, utilisez un navigateur basé sur Chromium.");     
    }
}
)();
...
function uni() {
   // alert("ok");
    ...
    // config.matchWebGLToCanvasSize = false; test121215454515
